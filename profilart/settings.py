...
DATABASES = {
    'default': {
        ...
        'NAME': 'nicolasgiannuzzi_profilart',                      # Or path to database file if using sqlite3.
        # The following settings are not used with sqlite3:
        'USER': '80645',
        'PASSWORD': 'profilart5mysql',
...
SECRET_KEY = 'r@c6f*z+lot#qne32*%&ctui24t3ay5mpff=su67@*%qz_dh6i'
...
ROOT_URLCONF = 'profilart.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'profilart.wsgi.application'
